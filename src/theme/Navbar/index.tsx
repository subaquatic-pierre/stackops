    ...
    <nav className="navbar sticky top-0 z-50 backdrop-blur-md bg-white/70 dark:bg-surface-0/70 border-b border-black/5 dark:border-white/[0.04]">
      <div className="container flex items-center justify-between">
        ...
        <div className="flex items-center">
          {isDocsPage ? (
            /* On doc pages: logo triggers left category drawer */
            <button
            ...
            /* On non-doc pages: logo navigates home */
            <Logo />
          )}
        </div>
        {/* Desktop Links */}
      ...
      {/* Mobile Site-Nav Slide-in (all pages — shows main site links) */}
      {/* Backdrop */}
      <div
      ...
      <div
        className={`md:hidden fixed top-0 right-0 z-50 h-screen w-72 flex flex-col overflow-hidden bg-white dark:bg-surface-0 shadow-2xl border-l border-black/5 dark:border-white/[0.06] transition-transform duration-300 ease-in-out ${
