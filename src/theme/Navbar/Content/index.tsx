...
export default function NavbarContent(): ReactNode {
  ...
  const leftContent = (
    <>
      {/* On doc pages: logo triggers category drawer; hamburger is on the right */}
      {/* On other pages: hamburger on left, logo is standard link */}
      ...
      <div className="hidden min-[996px]:flex items-center gap-8">
        <Link
          to="/docs/"
          className="flex items-center gap-2 text-sm font-medium text-slate-400 hover:text-white transition-colors cursor-pointer hover:no-underline"
        >
  ...
  const rightContent = (
    <>
      <div className="hidden min-[996px]:flex items-center gap-6">
        <Link
  ...
  return <NavbarContentLayout left={leftContent} right={rightContent} />;
}
