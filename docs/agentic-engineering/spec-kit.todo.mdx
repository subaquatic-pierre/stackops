...
- install spec kit and get started with spec kit

- command explaintions and development workflow

- this is copied from the docs on github for spec kit. make this docs more concise, change the wording, make it our own, most important is to be able to quick access commands and workflow
